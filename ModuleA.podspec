...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/LJModuleDemo/ModuleA"
  ...
  s.source       = { :git => "https://github.com/LJModuleDemo/ModuleA.git", :tag => s.version.to_s }
  ...
  s.source_files  = "ModuleA/ModuleA/**/*.{h,m}"
  ...
  # s.resource  = "icon.png"
  s.resources = "ModuleA/ModuleA/**/ModuleAViewController.xib"
